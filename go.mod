...
require (
	...
	github.com/loheagn/harbor-client v0.3.0
	...
	github.com/rancher/rancher/pkg/client v0.0.0-20210908211226-4cb495644eb8
...
require (
	...
	github.com/goharbor/harbor/src v0.0.0-20210924110755-63b8e6a9ce7b // indirect
